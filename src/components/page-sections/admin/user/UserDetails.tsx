        ...
        <Drawer direction="right" open={isOpen} onOpenChange={setIsOpen}>
            <DrawerContent className="inset-x-auto inset-y-0 right-0 m-3 w-full max-w-[450px] rounded-xl bg-background after:!bg-transparent">
                ...
                <ScrollArea className="w-full p-4">
                    {isLoading ? <p className="text-center">Loading...</p> : <div>
                        <div className="relative mb-20 px-2">
                            <Image
                                src={getImageURL(userDetail.bannerImage) || "/images/banner-placeholder.png"}
                                alt="Banner Image"
                                width={400}
                                height={300}
                                className="w-full aspect-video rounded-md"
                            />
                            <div className="flex justify-center -translate-y-1/2 absolute top-full left-1/2 -translate-x-1/2">
                                <Image
                                    src={getImageURL(userDetail.profileImage) || "/images/user-placeholder.png"}
                                    alt="Profile Image"
                                    width={200}
                                    height={200}
                                    className="w-[160px] aspect-square rounded-full border-8 border-base-0"
                                />
                            </div>
                        </div>
                        <div className="mb-4">
